...
/// <summary>
/// Third-person camera controller that orbits around a target transform.
/// Handles smooth following, rotation (with optional axis inversion), zooming, and obstruction avoidance.
/// Designed for responsive player tracking with adjustable sharpness and framing controls.
/// </summary>
public class PlayerCamera : MonoBehaviour
{
    [Header("Framing")]
    public Camera Camera;
    private Vector2 _followPointFraming = new Vector2(0f, 0f);
    ...
    /// <summary>
    /// Camera move speed, higher = faster, like mouse sensitivity
    /// </summary>
